...
import { Button, Typography, Box, Paper, TextField, Switch, FormControlLabel, Alert, List, ListItem, ListItemText, Chip } from '@mui/material';
...
export default function PDFDotActivator() {
  ...
  const handleGeneratePDF = async () => {
    try {
      ...
      const originalFillSpecificDotFields = generator.fillSpecificDotFields.bind(generator);
  ...
  return (
    <Box sx={{ p: 2 }}>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        Este componente te permite activar campos de dots específicos en el PDF editable.
      </Typography>
      ...
      {success && (
        <Paper sx={{ p: 2, mb: 2, bgcolor: 'success.light' }}>
          <Alert severity="success">
            ...
            <Typography>PDF generado con los campos de dots activados.</Typography>
          </Alert>
        </Paper>
      )}
      ...
      <Paper sx={{ p: 2 }}>
        ...
        <Typography variant="body2" component="div">
          <ul>
            <li>Agrega el nombre exacto del campo que quieres activar (ej: dot317b)</li>

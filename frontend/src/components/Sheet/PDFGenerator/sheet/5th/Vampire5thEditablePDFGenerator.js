...
export default class Vampire5thEditablePDFGenerator extends BaseEditablePDFGenerator {
  ...
  fillSpecificDotFields(form) {
    ...
    // También manejar patrones especiales de último nivel (ab o ba)
    Object.entries(dotMapping).forEach(([dotName, config]) => {
      const { skill, level, type } = config;
      
      // Verificar patrones de último nivel
      if (level === 5) {
        const skillValue = getSkillValue(skill, type);
        
        // Crear variantes ab y ba para el último nivel
        const dotVariants = [
          dotName.replace(/b$/, "ab"),
          dotName.replace(/b$/, "ba")
        ];
        
        dotVariants.forEach(variantName => {
          if (skillValue === 5) {
            this.fillCheckboxField(form, variantName, true);
            console.log(`Activado variante ${variantName}: ${skill} (${type}) máximo nivel`);
          }
        });
      }
    });
  ...
  getDotMapping() {
    return {
      ...
      dot9b: { skill: "strength", level: 5, type: "attribute" },
      ...
      dot17b: { skill: "dexterity", level: 5, type: "attribute" },
      ...
      dot25b: { skill: "stamina", level: 5, type: "attribute" },
      ...
      dot33b: { skill: "charisma", level: 5, type: "attribute" },
      ...
      dot41b: { skill: "manipulation", level: 5, type: "attribute" },
      ...
      dot49b: { skill: "composure", level: 5, type: "attribute" },
      ...
      dot57b: { skill: "intelligence", level: 5, type: "attribute" },
      ...
      dot65b: { skill: "wits", level: 5, type: "attribute" },
      ...
      dot73b: { skill: "resolve", level: 5, type: "attribute" },
      ...
      dot81b: { skill: "athletics", level: 5, type: "skill" },
      ...
      dot89b: { skill: "brawl", level: 5, type: "skill" },
      ...
      dot97b: { skill: "craft", level: 5, type: "skill" },
      ...
      dot105b: { skill: "drive", level: 5, type: "skill" },
      ...
      dot113b: { skill: "firearms", level: 5, type: "skill" },
      ...
      dot121b: { skill: "larceny", level: 5, type: "skill" },
      ...
      dot129b: { skill: "melee", level: 5, type: "skill" },
      ...
      dot137b: { skill: "stealth", level: 5, type: "skill" },
      ...
      dot145b: { skill: "survival", level: 5, type: "skill" },
      ...
      dot153b: { skill: "animal_ken", level: 5, type: "skill" },
      ...
      dot161b: { skill: "etiquette", level: 5, type: "skill" },
      ...
      dot169b: { skill: "insight", level: 5, type: "skill" },
      ...
      dot177b: { skill: "intimidation", level: 5, type: "skill" },
      ...
      dot185b: { skill: "leadership", level: 5, type: "skill" },
      ...
      dot193b: { skill: "performance", level: 5, type: "skill" },
      ...
      dot201b: { skill: "persuasion", level: 5, type: "skill" },
      ...
      dot209b: { skill: "streetwise", level: 5, type: "skill" },
      ...
      dot217b: { skill: "subterfuge", level: 5, type: "skill" },
      ...
      dot225b: { skill: "academics", level: 5, type: "skill" },
      ...
      dot233b: { skill: "awareness", level: 5, type: "skill" },
      ...
      dot241b: { skill: "finance", level: 5, type: "skill" },
      ...
      dot249b: { skill: "investigation", level: 5, type: "skill" },
      ...
      dot257b: { skill: "medicine", level: 5, type: "skill" },
      ...
      dot265b: { skill: "occult", level: 5, type: "skill" },
      ...
      dot273b: { skill: "politics", level: 5, type: "skill" },
      ...
      dot281b: { skill: "science", level: 5, type: "skill" },
      ...
      dot289b: { skill: "technology", level: 5, type: "skill" },
    };
  }
}

      ...
      >
        ...
        <Grid container item columnSpacing={3} rowSpacing={2} xs={12}>
          <Grid item xs={6} sx={{textAlign: 'center'}}>
            <Typography variant='h4' component='h2' color='primary' sx={{pb: 1}}>
          ...
          <Grid item xs={6} sx={{textAlign: 'center'}}>
            ...
            <Divider />
            <Typography sx={{pt: 1}}>Bestial Fail: {results.bestialFail}</Typography>
            <Typography>Total Fail: {results.totalFail}</Typography>
            <Typography>Fail: {results.fail}</Typography>
          </Grid>          
          <Grid item xs={12} sx={{textAlign: 'center'}}>
            <Typography>Highest Possible Success: {results.highest}</Typography>
            <Typography>Average Successes Rolled: {results.average}</Typography>
          </Grid>
        </Grid>        
      </Grid>

          ...
          <Container disableGutters sx={{py: 5, px: 5}}>
            ...
            <Typography component="div">
              <ul>
                ...
                <li>
                  Supports specialities (correctly handles removal by 1s 
                  with speciality tens.)
                </li>
                <li>Supports guaranteed successes and guaranteed failures</li>
                <li>
                  Supports willpower use. Adds 1 automatic success and 
                  notes WP as being used
                </li>
                <li>
                  Displays all dice as emojis in the order they were rolled. 
                  As well as in text ordered for easy reading
                </li>
                <li>
                  Easy to read colour-coded output that tells you everything 
                   you need to know about the roll at a glance
                </li>
                <li>
                  Supports linking of tracked characters. This will 
                  automaticly remove willpower when used as well as display 
                  the characters name in the roll
                </li>
            ...
            <Typography component="div">
              <ul>
                ...
                <li>
                  Keeps the tracker at the bottom of the channel every time 
                  a command is used as well as deleting the old message to 
                  keep the channel from becoming cluttered
                </li>
                <li>Pings users on their turn to declare an action</li>
                <li>Easy to use design</li>
                <li>
                  Easy to read output that shows only the information you 
                  need to see
                </li>
                <li>Supports multiple characters from one User</li>
                <li>Supports multiple rounds and keeps track for you</li>
                <li>
                  Supports changing your roll before the reveal if you made 
                  a mistake
                </li>
              </ul>
            </Typography>
            ...
            <Typography component="div">
              <ul>
                ...
                <li>
                  Easy to use Discord Slash Commands walk you through all 
                  the arguments with helpful descriptions on all of them
                </li>
                <li>
                  Character security, not just anyone can lookup or modify 
                  a character you have made
                </li>
                <li>
                ...
                <li>
                  Supports an ST tracker channel to see all the character updates 
                  in real time in a channel no one else can view. No more metagaming
                </li>
                <li>

...
function getCommands() {
  const slashCommand = new SlashCommandBuilder()
    ...
    .setDescription("Create a new Changeling character.")
    ...
    .addIntegerOption((option) =>
      option
        .setName("glamour")
        .setDescription("Total Glamour Pool (1-10).")
        .setMinValue(1)
        .setMaxValue(10)
        .setRequired(true)
    )
    ...
    .addIntegerOption((option) =>
      option
        .setName("banality")
        .setDescription("Total Banality Pool (1-10).")
        .setMinValue(1)
        .setMaxValue(10)
        .setRequired(true)
    )
    ...
    .addIntegerOption((option) =>
      option
        .setName("nightmare")
        .setDescription("Total Nightmare (0-10).")
        .setMinValue(0)
        .setMaxValue(10)
    )
    ...
    .addIntegerOption((option) =>
      option
        .setName("imbalance")
        .setDescription("Total Imbalance (0-10).")
        .setMinValue(0)
        .setMaxValue(10)
    )
    ...
    .addIntegerOption((option) =>
      option
        ...
        .setDescription("Total Chimerical Health (7-15). Defaults to 7.")
        .setMinValue(7)
        .setMaxValue(15)
    )
